...
# Local
from . import filterblock, iterblock, llmblock, utilblocks
...
class Pipeline:
    ...
    def generate(self, dataset) -> Dataset:
        ...
        for block_prop in self.chained_blocks:
            ...
            if block_type == iterblock.IterBlock:
                block_config["block_type"] = _lookup_block_type(
                    block_config["block_type"]
                )
